...
function Prontuario() {
  ...
  const loadLucasApi = (prontuario) => {
    ...
    axios.get('http://192.168.100.6:5000/attendances/?attendance_id=597').then((response) => {
